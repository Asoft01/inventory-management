            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="user" @submit.prevent="ProductInsert">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                         ...
                                         <input type="date" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Joining" v-model="form.buying_date">
                                         <small class="text-danger" v-if="errors.buying_date">{{ errors.joining_date[0] }}</small>
                                    </div>

                                    <div class="col-md-6">
                                         <label for="exampleFormControlSelect1">Product Quantity</label>
                                         <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Product Quantity" v-model="form.product_quantity">
